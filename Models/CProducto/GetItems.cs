...
namespace apiwise.Models.CProducto
{
    ...
    public class GetItems
    {
        public GetItems()
        {
            EmpresaProductos = new EmpresasItemsDto();
            LineasItem = new LineaDto();
            CategoriaItem = new CategoriaDto();
            GrupoItem = new GrupoDto();
            MarcaItem = new MarcaDto();
            TiposItem = new TiposProductoDto();
        }
        ...
        public EmpresasItemsDto EmpresaProductos { get; set; }
        public LineaDto LineasItem { get; set; } = null!;
        public CategoriaDto CategoriaItem { get; set; } = null!;
        public GrupoDto GrupoItem { get; set; } = null!;
        public MarcaDto MarcaItem { get; set; } = null!;
        public TiposProductoDto TiposItem { get; set; } = null!;
    }
}
