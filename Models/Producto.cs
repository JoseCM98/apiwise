...
namespace apiwise.Models
{
    ...
    public partial class Producto
    {
        ...
        public Producto()
        {
            ...
            LineasProductoNavigation = new Linea();
            CategoriasProductoNavigation = new Categoria();
            GruposProductoNavigation = new Grupo();
            MarcasProductoNavigation = new Marca();
            TiposProductoNavigation = new Tiposproducto();
        }
        ...
        public DateOnly FechaCreacionProducto { get; set; }
        ...
        public DateOnly FechaVigenciaRegistroSanitarioProducto { get; set; }
        ...
        public ICollection<Empresasproducto> Empresasproductos { get; set; }
        public Linea LineasProductoNavigation { get; set; } = null!;
        public Categoria CategoriasProductoNavigation { get; set; } = null!;
        public Grupo GruposProductoNavigation { get; set; } = null!;
        public Marca MarcasProductoNavigation { get; set; } = null!;
        public Tiposproducto TiposProductoNavigation { get; set; }
    }
}
